...
class TensCity extends HTMLElement {
    ...
    _showMenu() {
        ...
        // Add inline styles to prevent icon from expanding
        octocatSvg.style.flexShrink = '0';
        octocatSvg.style.minWidth = '16px';
        octocatSvg.style.minHeight = '16px';
        octocatSvg.style.maxWidth = '16px';
        octocatSvg.style.maxHeight = '16px';
